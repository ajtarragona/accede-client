...
*searchTercersBySurnames($surname1, $surname2)* | `surname1`: primer cognom del tercer (que contingui)<br/>`surname2`: segon cognom del tercer (que contingui)  | Un array d'objectes `Tercer`
